...
#=============== AJUSTE DE ALEATORIEDAD ======================
    ...
    while aleatoriedad == "no":        
        ...
        if eleccion_aleatoriedad == 1:
            rango_random = int(input("Ingrese el valor, de 1 a 100, para dejar seteada la aleatoriedad: "))
            print("{0}% sera la nueva aleatoriedad para la partida!.".format(rango_random))
            aleatoriedad = "si"
